...
# BASE_URL = "https://SpikeInterface.github.io/"
BLOG_EMAIL = "sam.garcia.die@gmail.com"
BLOG_DESCRIPTION = "spikeinterface report"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
    ("/index.html", "Home"),
     ("/archive.html", "Notebook examples"),
        #~ ("/categories/", "Tags"),
        #~ ("/rss.xml", "RSS feed"),
...
POSTS = (
    ...
    ("posts/*.ipynb", "blog", "post.tmpl"), # samuel garcia for jupyter notbook
)
PAGES = (
    ("pages/*.rst", "", "page.tmpl"),
    ("pages/*.md", "", "page.tmpl"),
    ...
    ("pages/*.ipynb", "", "page.tmpl"), # samuel garcia for jupyter notbook
)
